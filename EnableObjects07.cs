...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
		if (PlayerDatabase.GameplayLine == "F1D1") {
			// P1
			if (PlayerDatabase.GameplayPossession == "P1LW1") {
				ActionText.text = PlayerDatabase.P1C1 + " won the faceoff and " + PlayerDatabase.P1LW1 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RW1") {
				ActionText.text = PlayerDatabase.P1C1 + " won the faceoff and " + PlayerDatabase.P1RW1 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1LD1") {
				ActionText.text = PlayerDatabase.P1C1 + " won the faceoff and " + PlayerDatabase.P1LD1 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RD1") {
				ActionText.text = PlayerDatabase.P1C1 + " won the faceoff and " + PlayerDatabase.P1RD1 + " now has possession of the puck.";
			}

			// P2
			if (PlayerDatabase.GameplayPossession == "P2LW1") {
				ActionText.text = PlayerDatabase.P2C1 + " won the faceoff and " + PlayerDatabase.P2LW1 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RW1") {
				ActionText.text = PlayerDatabase.P2C1 + " won the faceoff and " + PlayerDatabase.P2RW1 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2LD1") {
				ActionText.text = PlayerDatabase.P2C1 + " won the faceoff and " + PlayerDatabase.P2LD1 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RD1") {
				ActionText.text = PlayerDatabase.P2C1 + " won the faceoff and " + PlayerDatabase.P2RD1 + " now has possession of the puck.";
			}
		}

		else if (PlayerDatabase.GameplayLine == "F2D1") {
			// P1
			if (PlayerDatabase.GameplayPossession == "P1LW2") {
				ActionText.text = PlayerDatabase.P1C2 + " won the faceoff and " + PlayerDatabase.P1LW2 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RW2") {
				ActionText.text = PlayerDatabase.P1C2 + " won the faceoff and " + PlayerDatabase.P1RW2 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1LD1") {
				ActionText.text = PlayerDatabase.P1C2 + " won the faceoff and " + PlayerDatabase.P1LD1 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RD1") {
				ActionText.text = PlayerDatabase.P1C2 + " won the faceoff and " + PlayerDatabase.P1RD1 + " now has possession of the puck.";
			}

			// P2
			if (PlayerDatabase.GameplayPossession == "P2LW2") {
				ActionText.text = PlayerDatabase.P2C2 + " won the faceoff and " + PlayerDatabase.P2LW2 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RW2") {
				ActionText.text = PlayerDatabase.P2C2 + " won the faceoff and " + PlayerDatabase.P2RW2 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2LD1") {
				ActionText.text = PlayerDatabase.P2C2 + " won the faceoff and " + PlayerDatabase.P2LD1 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RD1") {
				ActionText.text = PlayerDatabase.P2C2 + " won the faceoff and " + PlayerDatabase.P2RD1 + " now has possession of the puck.";
			}
		}
			...
			if (PlayerDatabase.GameplayPossession == "P1LW2") {
				...
				ActionText.text = PlayerDatabase.P1C2 + " won the faceoff and " + PlayerDatabase.P1LD2 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RD2") {
				ActionText.text = PlayerDatabase.P1C2 + " won the faceoff and " + PlayerDatabase.P1RD2 + " now has possession of the puck.";
			}
			...
			if (PlayerDatabase.GameplayPossession == "P2LW2") {
				...
				ActionText.text = PlayerDatabase.P2C2 + " won the faceoff and " + PlayerDatabase.P2LD2 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RD2") {
				ActionText.text = PlayerDatabase.P2C2 + " won the faceoff and " + PlayerDatabase.P2RD2 + " now has possession of the puck.";
			}
		}

		else if (PlayerDatabase.GameplayLine == "F3D2") {
			// P1
			if (PlayerDatabase.GameplayPossession == "P1LW3") {
				ActionText.text = PlayerDatabase.P1C3 + " won the faceoff and " + PlayerDatabase.P1LW3 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RW3") {
				ActionText.text = PlayerDatabase.P1C3 + " won the faceoff and " + PlayerDatabase.P1RW3 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1LD2") {
				ActionText.text = PlayerDatabase.P1C3 + " won the faceoff and " + PlayerDatabase.P1LD2 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RD2") {
				ActionText.text = PlayerDatabase.P1C3 + " won the faceoff and " + PlayerDatabase.P1RD2 + " now has possession of the puck.";
			}

			// P2
			if (PlayerDatabase.GameplayPossession == "P2LW3") {
				ActionText.text = PlayerDatabase.P2C3 + " won the faceoff and " + PlayerDatabase.P2LW3 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RW3") {
				ActionText.text = PlayerDatabase.P2C3 + " won the faceoff and " + PlayerDatabase.P2RW3 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2LD2") {
				ActionText.text = PlayerDatabase.P2C3 + " won the faceoff and " + PlayerDatabase.P2LD2 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RD2") {
				ActionText.text = PlayerDatabase.P2C3 + " won the faceoff and " + PlayerDatabase.P2RD2 + " now has possession of the puck.";
			}
		}
			...
			if (PlayerDatabase.GameplayPossession == "P1LW3") {
				...
				ActionText.text = PlayerDatabase.P1C3 + " won the faceoff and " + PlayerDatabase.P1LD3 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RD3") {
				ActionText.text = PlayerDatabase.P1C3 + " won the faceoff and " + PlayerDatabase.P1RD3 + " now has possession of the puck.";
			}
			...
			if (PlayerDatabase.GameplayPossession == "P2LW3") {
				...
				ActionText.text = PlayerDatabase.P2C3 + " won the faceoff and " + PlayerDatabase.P2LD3 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RD3") {
				ActionText.text = PlayerDatabase.P2C3 + " won the faceoff and " + PlayerDatabase.P2RD3 + " now has possession of the puck.";
			}
		}

		else if (PlayerDatabase.GameplayLine == "F4D3") {
			// P1
			if (PlayerDatabase.GameplayPossession == "P1LW4") {
				ActionText.text = PlayerDatabase.P1C4 + " won the faceoff and " + PlayerDatabase.P1LW4 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RW4") {
				ActionText.text = PlayerDatabase.P1C4 + " won the faceoff and " + PlayerDatabase.P1RW4 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1LD3") {
				ActionText.text = PlayerDatabase.P1C4 + " won the faceoff and " + PlayerDatabase.P1LD3 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P1RD3") {
				ActionText.text = PlayerDatabase.P1C4 + " won the faceoff and " + PlayerDatabase.P1RD3 + " now has possession of the puck.";
			}

			// P2
			if (PlayerDatabase.GameplayPossession == "P2LW4") {
				ActionText.text = PlayerDatabase.P2C4 + " won the faceoff and " + PlayerDatabase.P2LW4 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RW4") {
				ActionText.text = PlayerDatabase.P2C4 + " won the faceoff and " + PlayerDatabase.P2RW4 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2LD3") {
				ActionText.text = PlayerDatabase.P2C4 + " won the faceoff and " + PlayerDatabase.P2LD3 + " now has possession of the puck.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2RD3") {
				ActionText.text = PlayerDatabase.P2C4 + " won the faceoff and " + PlayerDatabase.P2RD3 + " now has possession of the puck.";
			}
		}
	}
