...
// --------------- PUBLIC VARIABLES ---------------
	...
	public Image GoalieRatingButton;
...
// --------------- ENABLING OBEJCTS FUNCTIONS ---------------
	public void EnableMainObjects() {
		...
		GoalieRatingButton.enabled = true;
	}
...
// --------------- DISABLING OBEJCTS FUNCTIONS ---------------
	public void DisableMainObjects() {
		...
		GoalieRatingButton.enabled = false;
	}
...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
			if (PlayerDatabase.GameplayPossession == "P1G") {
				ActionText.text = PlayerDatabase.P1G + " is about to roll for a goalie rating.";
			}

			else if (PlayerDatabase.GameplayPossession == "P2G") {
				ActionText.text = PlayerDatabase.P2G + " is about to roll for a goalie rating.";
			}
	}
	...
	public void UpdatingOverlayTexts() {
		...
		if (ShowingOverlayString == "P1G") {
			...
			if (PlayerDatabase.CurrentFranchiseSelect == 1) {
				GoalieRating02.text = "2) " + GStatsGoalieRating02.PlayerGStatsGoalieRating02[PlayerDatabase.P1G];
				GoalieRating03.text = "3) " + GStatsGoalieRating03.PlayerGStatsGoalieRating03[PlayerDatabase.P1G];
				GoalieRating04.text = "4) " + GStatsGoalieRating04.PlayerGStatsGoalieRating04[PlayerDatabase.P1G];
				GoalieRating05.text = "5) " + GStatsGoalieRating05.PlayerGStatsGoalieRating05[PlayerDatabase.P1G];
				GoalieRating06.text = "6) " + GStatsGoalieRating06.PlayerGStatsGoalieRating06[PlayerDatabase.P1G];
				GoalieRating07.text = "7) " + GStatsGoalieRating07.PlayerGStatsGoalieRating07[PlayerDatabase.P1G];
				GoalieRating08.text = "8) " + GStatsGoalieRating08.PlayerGStatsGoalieRating08[PlayerDatabase.P1G];
				GoalieRating09.text = "9) " + GStatsGoalieRating09.PlayerGStatsGoalieRating09[PlayerDatabase.P1G];
				GoalieRating10.text = "10) " + GStatsGoalieRating10.PlayerGStatsGoalieRating10[PlayerDatabase.P1G];
				GoalieRating11.text = "11) " + GStatsGoalieRating11.PlayerGStatsGoalieRating11[PlayerDatabase.P1G];
				GoalieRating12.text = "12) " + GStatsGoalieRating12.PlayerGStatsGoalieRating12[PlayerDatabase.P1G];
			}

			else if (PlayerDatabase.CurrentFranchiseSelect == 2) {
				GoalieRating02.text = "2) " + GStatsGoalieRating02.FrPlayerGStatsGoalieRating02[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating03.text = "3) " + GStatsGoalieRating03.FrPlayerGStatsGoalieRating03[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating04.text = "4) " + GStatsGoalieRating04.FrPlayerGStatsGoalieRating04[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating05.text = "5) " + GStatsGoalieRating05.FrPlayerGStatsGoalieRating05[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating06.text = "6) " + GStatsGoalieRating06.FrPlayerGStatsGoalieRating06[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating07.text = "7) " + GStatsGoalieRating07.FrPlayerGStatsGoalieRating07[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating08.text = "8) " + GStatsGoalieRating08.FrPlayerGStatsGoalieRating08[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating09.text = "9) " + GStatsGoalieRating09.FrPlayerGStatsGoalieRating09[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating10.text = "10) " + GStatsGoalieRating10.FrPlayerGStatsGoalieRating10[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating11.text = "11) " + GStatsGoalieRating11.FrPlayerGStatsGoalieRating11[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
				GoalieRating12.text = "12) " + GStatsGoalieRating12.FrPlayerGStatsGoalieRating12[PlayerDatabase.P1G + PlayerDatabase.PlayerChosenTeam];
			}
		}
			...
			if (PlayerDatabase.CurrentFranchiseSelect == 1) {
				GoalieRating02.text = "2) " + GStatsGoalieRating02.PlayerGStatsGoalieRating02[PlayerDatabase.P2G];
				GoalieRating03.text = "3) " + GStatsGoalieRating03.PlayerGStatsGoalieRating03[PlayerDatabase.P2G];
				GoalieRating04.text = "4) " + GStatsGoalieRating04.PlayerGStatsGoalieRating04[PlayerDatabase.P2G];
				GoalieRating05.text = "5) " + GStatsGoalieRating05.PlayerGStatsGoalieRating05[PlayerDatabase.P2G];
				GoalieRating06.text = "6) " + GStatsGoalieRating06.PlayerGStatsGoalieRating06[PlayerDatabase.P2G];
				GoalieRating07.text = "7) " + GStatsGoalieRating07.PlayerGStatsGoalieRating07[PlayerDatabase.P2G];
				GoalieRating08.text = "8) " + GStatsGoalieRating08.PlayerGStatsGoalieRating08[PlayerDatabase.P2G];
				GoalieRating09.text = "9) " + GStatsGoalieRating09.PlayerGStatsGoalieRating09[PlayerDatabase.P2G];
				GoalieRating10.text = "10) " + GStatsGoalieRating10.PlayerGStatsGoalieRating10[PlayerDatabase.P2G];
				GoalieRating11.text = "11) " + GStatsGoalieRating11.PlayerGStatsGoalieRating11[PlayerDatabase.P2G];
				GoalieRating12.text = "12) " + GStatsGoalieRating12.PlayerGStatsGoalieRating12[PlayerDatabase.P2G];
			}

			else if (PlayerDatabase.CurrentFranchiseSelect == 2) {
				GoalieRating02.text = "2) " + GStatsGoalieRating02.FrPlayerGStatsGoalieRating02[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating03.text = "3) " + GStatsGoalieRating03.FrPlayerGStatsGoalieRating03[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating04.text = "4) " + GStatsGoalieRating04.FrPlayerGStatsGoalieRating04[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating05.text = "5) " + GStatsGoalieRating05.FrPlayerGStatsGoalieRating05[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating06.text = "6) " + GStatsGoalieRating06.FrPlayerGStatsGoalieRating06[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating07.text = "7) " + GStatsGoalieRating07.FrPlayerGStatsGoalieRating07[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating08.text = "8) " + GStatsGoalieRating08.FrPlayerGStatsGoalieRating08[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating09.text = "9) " + GStatsGoalieRating09.FrPlayerGStatsGoalieRating09[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating10.text = "10) " + GStatsGoalieRating10.FrPlayerGStatsGoalieRating10[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating11.text = "11) " + GStatsGoalieRating11.FrPlayerGStatsGoalieRating11[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
				GoalieRating12.text = "12) " + GStatsGoalieRating12.FrPlayerGStatsGoalieRating12[PlayerDatabase.P2G + PlayerDatabase.ComputerChosenTeam];
			}
		}
	}

	public void UpdateToGoaliePossession() {
		if (PlayerDatabase.GameplayPossession.Contains("P1")) {
