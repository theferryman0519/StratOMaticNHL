...
public class EnableObjects18B : MonoBehaviour {
...
// --------------- STATIC VARIABLES ---------------
	...
	public static string PasserFromPlayer;
	public static string PasserToPlayer;
...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
		// Get From Strings
		// Player
		if (GameplayPassing.InitialPasserString == "P1C1") {
			PasserFromPlayer = PlayerDatabase.P1C1;
		}

		else if (GameplayPassing.InitialPasserString == "P1C2") {
			PasserFromPlayer = PlayerDatabase.P1C2;
		}

		else if (GameplayPassing.InitialPasserString == "P1C3") {
			PasserFromPlayer = PlayerDatabase.P1C3;
		}

		else if (GameplayPassing.InitialPasserString == "P1C4") {
			PasserFromPlayer = PlayerDatabase.P1C4;
		}

		else if (GameplayPassing.InitialPasserString == "P1LW1") {
			PasserFromPlayer = PlayerDatabase.P1LW1;
		}

		else if (GameplayPassing.InitialPasserString == "P1LW2") {
			PasserFromPlayer = PlayerDatabase.P1LW2;
		}

		else if (GameplayPassing.InitialPasserString == "P1LW3") {
			PasserFromPlayer = PlayerDatabase.P1LW3;
		}

		else if (GameplayPassing.InitialPasserString == "P1LW4") {
			PasserFromPlayer = PlayerDatabase.P1LW4;
		}

		else if (GameplayPassing.InitialPasserString == "P1RW1") {
			PasserFromPlayer = PlayerDatabase.P1RW1;
		}

		else if (GameplayPassing.InitialPasserString == "P1RW2") {
			PasserFromPlayer = PlayerDatabase.P1RW2;
		}

		else if (GameplayPassing.InitialPasserString == "P1RW3") {
			PasserFromPlayer = PlayerDatabase.P1RW3;
		}

		else if (GameplayPassing.InitialPasserString == "P1RW4") {
			PasserFromPlayer = PlayerDatabase.P1RW4;
		}

		else if (GameplayPassing.InitialPasserString == "P1LD1") {
			PasserFromPlayer = PlayerDatabase.P1LD1;
		}

		else if (GameplayPassing.InitialPasserString == "P1LD2") {
			PasserFromPlayer = PlayerDatabase.P1LD2;
		}

		else if (GameplayPassing.InitialPasserString == "P1LD3") {
			PasserFromPlayer = PlayerDatabase.P1LD3;
		}

		else if (GameplayPassing.InitialPasserString == "P1RD1") {
			PasserFromPlayer = PlayerDatabase.P1RD1;
		}

		else if (GameplayPassing.InitialPasserString == "P1RD2") {
			PasserFromPlayer = PlayerDatabase.P1RD2;
		}

		else if (GameplayPassing.InitialPasserString == "P1RD3") {
			PasserFromPlayer = PlayerDatabase.P1RD3;
		}

		// Computer
		else if (GameplayPassing.InitialPasserString == "P2C1") {
			PasserFromPlayer = PlayerDatabase.P2C1;
		}

		else if (GameplayPassing.InitialPasserString == "P2C2") {
			PasserFromPlayer = PlayerDatabase.P2C2;
		}

		else if (GameplayPassing.InitialPasserString == "P2C3") {
			PasserFromPlayer = PlayerDatabase.P2C3;
		}

		else if (GameplayPassing.InitialPasserString == "P2C4") {
			PasserFromPlayer = PlayerDatabase.P2C4;
		}

		else if (GameplayPassing.InitialPasserString == "P2LW1") {
			PasserFromPlayer = PlayerDatabase.P2LW1;
		}

		else if (GameplayPassing.InitialPasserString == "P2LW2") {
			PasserFromPlayer = PlayerDatabase.P2LW2;
		}

		else if (GameplayPassing.InitialPasserString == "P2LW3") {
			PasserFromPlayer = PlayerDatabase.P2LW3;
		}

		else if (GameplayPassing.InitialPasserString == "P2LW4") {
			PasserFromPlayer = PlayerDatabase.P2LW4;
		}

		else if (GameplayPassing.InitialPasserString == "P2RW1") {
			PasserFromPlayer = PlayerDatabase.P2RW1;
		}

		else if (GameplayPassing.InitialPasserString == "P2RW2") {
			PasserFromPlayer = PlayerDatabase.P2RW2;
		}

		else if (GameplayPassing.InitialPasserString == "P2RW3") {
			PasserFromPlayer = PlayerDatabase.P2RW3;
		}

		else if (GameplayPassing.InitialPasserString == "P2RW4") {
			PasserFromPlayer = PlayerDatabase.P2RW4;
		}

		else if (GameplayPassing.InitialPasserString == "P2LD1") {
			PasserFromPlayer = PlayerDatabase.P2LD1;
		}

		else if (GameplayPassing.InitialPasserString == "P2LD2") {
			PasserFromPlayer = PlayerDatabase.P2LD2;
		}

		else if (GameplayPassing.InitialPasserString == "P2LD3") {
			PasserFromPlayer = PlayerDatabase.P2LD3;
		}

		else if (GameplayPassing.InitialPasserString == "P2RD1") {
			PasserFromPlayer = PlayerDatabase.P2RD1;
		}

		else if (GameplayPassing.InitialPasserString == "P2RD2") {
			PasserFromPlayer = PlayerDatabase.P2RD2;
		}

		else if (GameplayPassing.InitialPasserString == "P2RD3") {
			PasserFromPlayer = PlayerDatabase.P2RD3;
		}

		// Get To Strings
		// Player
		if (PlayerDatabase.GameplayPossession == "P1C1") {
			PasserToPlayer = PlayerDatabase.P1C1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C2") {
			PasserToPlayer = PlayerDatabase.P1C2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C3") {
			PasserToPlayer = PlayerDatabase.P1C3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C4") {
			PasserToPlayer = PlayerDatabase.P1C4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW1") {
			PasserToPlayer = PlayerDatabase.P1LW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW2") {
			PasserToPlayer = PlayerDatabase.P1LW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW3") {
			PasserToPlayer = PlayerDatabase.P1LW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW4") {
			PasserToPlayer = PlayerDatabase.P1LW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW1") {
			PasserToPlayer = PlayerDatabase.P1RW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW2") {
			PasserToPlayer = PlayerDatabase.P1RW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW3") {
			PasserToPlayer = PlayerDatabase.P1RW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW4") {
			PasserToPlayer = PlayerDatabase.P1RW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD1") {
			PasserToPlayer = PlayerDatabase.P1LD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD2") {
			PasserToPlayer = PlayerDatabase.P1LD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD3") {
			PasserToPlayer = PlayerDatabase.P1LD3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD1") {
			PasserToPlayer = PlayerDatabase.P1RD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD2") {
			PasserToPlayer = PlayerDatabase.P1RD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD3") {
			PasserToPlayer = PlayerDatabase.P1RD3;
		}

		// Computer
		else if (PlayerDatabase.GameplayPossession == "P2C1") {
			PasserToPlayer = PlayerDatabase.P2C1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C2") {
			PasserToPlayer = PlayerDatabase.P2C2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C3") {
			PasserToPlayer = PlayerDatabase.P2C3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C4") {
			PasserToPlayer = PlayerDatabase.P2C4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW1") {
			PasserToPlayer = PlayerDatabase.P2LW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW2") {
			PasserToPlayer = PlayerDatabase.P2LW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW3") {
			PasserToPlayer = PlayerDatabase.P2LW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW4") {
			PasserToPlayer = PlayerDatabase.P2LW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW1") {
			PasserToPlayer = PlayerDatabase.P2RW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW2") {
			PasserToPlayer = PlayerDatabase.P2RW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW3") {
			PasserToPlayer = PlayerDatabase.P2RW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW4") {
			PasserToPlayer = PlayerDatabase.P2RW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD1") {
			PasserToPlayer = PlayerDatabase.P2LD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD2") {
			PasserToPlayer = PlayerDatabase.P2LD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD3") {
			PasserToPlayer = PlayerDatabase.P2LD3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD1") {
			PasserToPlayer = PlayerDatabase.P2RD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD2") {
			PasserToPlayer = PlayerDatabase.P2RD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD3") {
			PasserToPlayer = PlayerDatabase.P2RD3;
		}

		// Set Action Text
		if (GameplayPassing.PassingString.Contains("Outside")) {
			if (PasserToPlayer == PasserFromPlayer) {
				ActionText.text = PasserFromPlayer + " successfully passes the puck off the boards to himself for an outside shot.";
			}

			else if ((GameplayPassing.InitialPasserString.Contains("P1")) && (PlayerDatabase.GameplayPossession.Contains("P2"))) {
				ActionText.text = PasserFromPlayer + " loses the puck to " + PasserToPlayer + " for an outside shot.";
			}

			else if ((GameplayPassing.InitialPasserString.Contains("P2")) && (PlayerDatabase.GameplayPossession.Contains("P1"))) {
				ActionText.text = PasserFromPlayer + " loses the puck to " + PasserToPlayer + " for an outside shot.";
			}

			else if ((GameplayPassing.InitialPasserString.Contains("P1")) && (PlayerDatabase.GameplayPossession.Contains("P1"))) {
				ActionText.text = PasserFromPlayer + " successfully passes the puck to " + PasserToPlayer + " for an outside shot.";
			}

			else if ((GameplayPassing.InitialPasserString.Contains("P2")) && (PlayerDatabase.GameplayPossession.Contains("P2"))) {
				ActionText.text = PasserFromPlayer + " successfully passes the puck to " + PasserToPlayer + " for an outside shot.";
			}
		}

		else if (GameplayPassing.PassingString.Contains("Inside")) {
			if (PasserToPlayer == PasserFromPlayer) {
				ActionText.text = PasserFromPlayer + " successfully passes the puck off the boards to himself for an inside shot.";
			}

			else if ((GameplayPassing.InitialPasserString.Contains("P1")) && (PlayerDatabase.GameplayPossession.Contains("P2"))) {
				ActionText.text = PasserFromPlayer + " loses the puck to " + PasserToPlayer + " for an inside shot.";
			}
				...
				ActionText.text = PasserFromPlayer + " successfully passes the puck to " + PasserToPlayer + " for an inside shot.";
			}
			...
			if (PasserToPlayer == PasserFromPlayer) {
				ActionText.text = PasserFromPlayer + " successfully passes the puck off the boards to himself.";
			}

			else if ((GameplayPassing.InitialPasserString.Contains("P1")) && (PlayerDatabase.GameplayPossession.Contains("P2"))) {
				ActionText.text = PasserFromPlayer + " loses the puck to " + PasserToPlayer + ", who now has possession.";
			}
				...
				ActionText.text = PasserFromPlayer + " successfully passes the puck to " + PasserToPlayer + ", who now has possession.";
			}
