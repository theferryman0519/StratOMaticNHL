...
public class EnableObjects19 : MonoBehaviour {
...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
		...
		if (PlayerDatabase.GameplayPossession == "P1C1") {
			ActionText.text = PlayerDatabase.P1C1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1C2") {
			ActionText.text = PlayerDatabase.P1C2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1C3") {
			ActionText.text = PlayerDatabase.P1C3 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1C4") {
			ActionText.text = PlayerDatabase.P1C4 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW1") {
			ActionText.text = PlayerDatabase.P1LW1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW2") {
			ActionText.text = PlayerDatabase.P1LW2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW3") {
			ActionText.text = PlayerDatabase.P1LW3 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW4") {
			ActionText.text = PlayerDatabase.P1LW4 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW1") {
			ActionText.text = PlayerDatabase.P1RW1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW2") {
			ActionText.text = PlayerDatabase.P1RW2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW3") {
			ActionText.text = PlayerDatabase.P1RW3 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW4") {
			ActionText.text = PlayerDatabase.P1RW4 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD1") {
			ActionText.text = PlayerDatabase.P1LD1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD2") {
			ActionText.text = PlayerDatabase.P1LD2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD3") {
			ActionText.text = PlayerDatabase.P1LD3 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD1") {
			ActionText.text = PlayerDatabase.P1RD1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD2") {
			ActionText.text = PlayerDatabase.P1RD2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD3") {
			ActionText.text = PlayerDatabase.P1RD3 + " caught the attention of the referees for a possible penalty.";
		}

		// P2
		else if (PlayerDatabase.GameplayPossession == "P2C1") {
			ActionText.text = PlayerDatabase.P2C1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2C2") {
			ActionText.text = PlayerDatabase.P2C2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2C3") {
			ActionText.text = PlayerDatabase.P2C3 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2C4") {
			ActionText.text = PlayerDatabase.P2C4 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW1") {
			ActionText.text = PlayerDatabase.P2LW1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW2") {
			ActionText.text = PlayerDatabase.P2LW2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW3") {
			ActionText.text = PlayerDatabase.P2LW3 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW4") {
			ActionText.text = PlayerDatabase.P2LW4 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW1") {
			ActionText.text = PlayerDatabase.P2RW1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW2") {
			ActionText.text = PlayerDatabase.P2RW2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW3") {
			ActionText.text = PlayerDatabase.P2RW3 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW4") {
			ActionText.text = PlayerDatabase.P2RW4 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD1") {
			ActionText.text = PlayerDatabase.P2LD1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD2") {
			ActionText.text = PlayerDatabase.P2LD2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD3") {
			ActionText.text = PlayerDatabase.P2LD3 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD1") {
			ActionText.text = PlayerDatabase.P2RD1 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD2") {
			ActionText.text = PlayerDatabase.P2RD2 + " caught the attention of the referees for a possible penalty.";
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD3") {
			ActionText.text = PlayerDatabase.P2RD3 + " caught the attention of the referees for a possible penalty.";
		}
	}
