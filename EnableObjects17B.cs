...
public class EnableObjects17B : MonoBehaviour {
...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
		...
		// Update Action Text
		if (GameplayOutsideShot.GenericShot == "Goalie Rating") {
			ActionText.text = "By rolling a " + GameplayOutsideShot.DiceRoll + ", " + CurrentShootingPlayer + " has a chance for a goalie rating.";
		}

		else if (GameplayOutsideShot.GenericShot == "Goal Chance") {
			ActionText.text = "By rolling a " + GameplayOutsideShot.DiceRoll + ", " + CurrentShootingPlayer + " has a chance for a goal.";
		}

		else if (GameplayOutsideShot.GenericShot == "Lose") {
			ActionText.text = "By rolling a " + GameplayOutsideShot.DiceRoll + ", " + CurrentShootingPlayer + " has lost the puck without a shot.";
		}

		else if (GameplayOutsideShot.GenericShot == "Rebound") {
			ActionText.text = "By rolling a " + GameplayOutsideShot.DiceRoll + ", " + CurrentShootingPlayer + " caused a rebound opportunity.";
		}

		else if (GameplayOutsideShot.GenericShot == "Shot") {
			ActionText.text = "By rolling a " + GameplayOutsideShot.DiceRoll + ", " + CurrentShootingPlayer + " shoots the puck, which is saved.";
		}
	}
