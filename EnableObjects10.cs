...
public class EnableObjects10 : MonoBehaviour {
	...
	public void UpdatingActionText() {
		...
		if ((PlayerDatabase.GameplayPossession != "P1G") && (PlayerDatabase.GameplayPossession != "P2G")) {
			if (PlayerDatabase.GameplayPossession.Contains("P1")) {
				ActionText.text = "The play is being reviewed for a goal on " + PlayerDatabase.P2G + ".";
			}

			else if (PlayerDatabase.GameplayPossession.Contains("P2")) {
				ActionText.text = "The play is being reviewed for a goal on " + PlayerDatabase.P1G + ".";
			}
		}
