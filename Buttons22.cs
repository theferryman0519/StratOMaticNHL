...
public class Buttons22 : MonoBehaviour {
...
// ---------------------------------------- START: CALLING OTHER SCRIPTS ----------------------------------------
	// Gameplay
	public GameplayRebBreakShot RunGameplayRebBreakShotRun;
...
// --------------- BUTTON FUNCTIONS ---------------
	public void ShotButtonClicking() {
		RunGameplayRebBreakShotRun.RunGameplayRebBreakShot();
	}

	public void PlayerFlipButtonClicking() {
		if (EnableObjects22.FlippingPlayerData == 0) {
			EnableObjects22.FlippingPlayerData = 1;
		}

		else if (EnableObjects22.FlippingPlayerData == 1) {
			EnableObjects22.FlippingPlayerData = 0;
		}
	}

	public void PlayerBackButtonClicking() {
		EnableObjects22.ShowingOverlayInt = 0;
	}

	public void P1CClicking() {
		EnableObjects22.ShowingOverlayInt = 1;

		if (PlayerDatabase.GameplayLine == "F1D1") {
			EnableObjects22.ShowingOverlayString = "P1C1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D1") || (PlayerDatabase.GameplayLine == "F2D2")) {
			EnableObjects22.ShowingOverlayString = "P1C2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D2") || (PlayerDatabase.GameplayLine == "F3D3")) {
			EnableObjects22.ShowingOverlayString = "P1C3";
		}

		else if (PlayerDatabase.GameplayLine == "F4D3") {
			EnableObjects22.ShowingOverlayString = "P1C4";
		}
	}
	...
	public void P1LWClicking() {
		...
		if (PlayerDatabase.GameplayLine == "F1D1") {
			EnableObjects22.ShowingOverlayString = "P1LW1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D1") || (PlayerDatabase.GameplayLine == "F2D2")) {
			EnableObjects22.ShowingOverlayString = "P1LW2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D2") || (PlayerDatabase.GameplayLine == "F3D3")) {
			EnableObjects22.ShowingOverlayString = "P1LW3";
		}

		else if (PlayerDatabase.GameplayLine == "F4D3") {
			EnableObjects22.ShowingOverlayString = "P1LW4";
		}
	}
	...
	public void P1RWClicking() {
		...
		if (PlayerDatabase.GameplayLine == "F1D1") {
			EnableObjects22.ShowingOverlayString = "P1RW1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D1") || (PlayerDatabase.GameplayLine == "F2D2")) {
			EnableObjects22.ShowingOverlayString = "P1RW2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D2") || (PlayerDatabase.GameplayLine == "F3D3")) {
			EnableObjects22.ShowingOverlayString = "P1RW3";
		}

		else if (PlayerDatabase.GameplayLine == "F4D3") {
			EnableObjects22.ShowingOverlayString = "P1RW4";
		}
	}
	...
	public void P1RDClicking() {
		...
		if ((PlayerDatabase.GameplayLine == "F1D1") || (PlayerDatabase.GameplayLine == "F2D1")) {
			EnableObjects22.ShowingOverlayString = "P1RD1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D2") || (PlayerDatabase.GameplayLine == "F3D2")) {
			EnableObjects22.ShowingOverlayString = "P1RD2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D3") || (PlayerDatabase.GameplayLine == "F4D3")) {
			EnableObjects22.ShowingOverlayString = "P1RD3";
		}
	}

	public void P1GClicking() {
		EnableObjects22.ShowingOverlayInt = 1;
		EnableObjects22.ShowingOverlayString = "P1G";
	}
	...
	public void P2CClicking() {
		...
		if (PlayerDatabase.GameplayLine == "F1D1") {
			EnableObjects22.ShowingOverlayString = "P2C1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D1") || (PlayerDatabase.GameplayLine == "F2D2")) {
			EnableObjects22.ShowingOverlayString = "P2C2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D2") || (PlayerDatabase.GameplayLine == "F3D3")) {
			EnableObjects22.ShowingOverlayString = "P2C3";
		}

		else if (PlayerDatabase.GameplayLine == "F4D3") {
			EnableObjects22.ShowingOverlayString = "P2C4";
		}
	}
	...
	public void P2LWClicking() {
		...
		if (PlayerDatabase.GameplayLine == "F1D1") {
			EnableObjects22.ShowingOverlayString = "P2LW1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D1") || (PlayerDatabase.GameplayLine == "F2D2")) {
			EnableObjects22.ShowingOverlayString = "P2LW2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D2") || (PlayerDatabase.GameplayLine == "F3D3")) {
			EnableObjects22.ShowingOverlayString = "P2LW3";
		}

		else if (PlayerDatabase.GameplayLine == "F4D3") {
			EnableObjects22.ShowingOverlayString = "P2LW4";
		}
	}
	...
	public void P2RWClicking() {
		...
		if (PlayerDatabase.GameplayLine == "F1D1") {
			EnableObjects22.ShowingOverlayString = "P2RW1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D1") || (PlayerDatabase.GameplayLine == "F2D2")) {
			EnableObjects22.ShowingOverlayString = "P2RW2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D2") || (PlayerDatabase.GameplayLine == "F3D3")) {
			EnableObjects22.ShowingOverlayString = "P2RW3";
		}

		else if (PlayerDatabase.GameplayLine == "F4D3") {
			EnableObjects22.ShowingOverlayString = "P2RW4";
		}
	}
	...
	public void P2LDClicking() {
		...
		if ((PlayerDatabase.GameplayLine == "F1D1") || (PlayerDatabase.GameplayLine == "F2D1")) {
			EnableObjects22.ShowingOverlayString = "P2LD1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D2") || (PlayerDatabase.GameplayLine == "F3D2")) {
			EnableObjects22.ShowingOverlayString = "P2LD2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D3") || (PlayerDatabase.GameplayLine == "F4D3")) {
			EnableObjects22.ShowingOverlayString = "P2LD3";
		}
	}
	...
	public void P2RDClicking() {
		...
		if ((PlayerDatabase.GameplayLine == "F1D1") || (PlayerDatabase.GameplayLine == "F2D1")) {
			EnableObjects22.ShowingOverlayString = "P2RD1";
		}

		else if ((PlayerDatabase.GameplayLine == "F2D2") || (PlayerDatabase.GameplayLine == "F3D2")) {
			EnableObjects22.ShowingOverlayString = "P2RD2";
		}

		else if ((PlayerDatabase.GameplayLine == "F3D3") || (PlayerDatabase.GameplayLine == "F4D3")) {
			EnableObjects22.ShowingOverlayString = "P2RD3";
		}
	}

	public void P2GClicking() {
		EnableObjects22.ShowingOverlayInt = 1;
		EnableObjects22.ShowingOverlayString = "P2G";
	}
