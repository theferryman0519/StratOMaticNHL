...
public class EnableObjects12B : MonoBehaviour {
...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
		...
		// Update Action Text
		if (GameplayInsideShot.GenericShot == "Goalie Rating") {
			ActionText.text = "By rolling a " + GameplayInsideShot.DiceRoll + ", " + CurrentShootingPlayer + " has a chance for a goalie rating.";
		}

		else if (GameplayInsideShot.GenericShot == "Goal Chance") {
			ActionText.text = "By rolling a " + GameplayInsideShot.DiceRoll + ", " + CurrentShootingPlayer + " has a chance for a goal.";
		}

		else if (GameplayInsideShot.GenericShot == "Lose") {
			ActionText.text = "By rolling a " + GameplayInsideShot.DiceRoll + ", " + CurrentShootingPlayer + " has lost the puck without a shot.";
		}

		else if (GameplayInsideShot.GenericShot == "Rebound") {
			ActionText.text = "By rolling a " + GameplayInsideShot.DiceRoll + ", " + CurrentShootingPlayer + " caused a rebound opportunity.";
		}

		else if (GameplayInsideShot.GenericShot == "Shot") {
			ActionText.text = "By rolling a " + GameplayInsideShot.DiceRoll + ", " + CurrentShootingPlayer + " shoots the puck, which is saved.";
		}
	}
