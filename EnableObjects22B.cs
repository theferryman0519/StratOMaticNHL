...
public class EnableObjects22B : MonoBehaviour {
...
// --------------- STATIC VARIABLES ---------------
	...
	public static string CurrentShootingPlayer;
...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
		...
		if (PlayerDatabase.GameplayPossession == "P1C1") {
			CurrentShootingPlayer = PlayerDatabase.P1C1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C2") {
			CurrentShootingPlayer = PlayerDatabase.P1C2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C3") {
			CurrentShootingPlayer = PlayerDatabase.P1C3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C4") {
			CurrentShootingPlayer = PlayerDatabase.P1C4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW1") {
			CurrentShootingPlayer = PlayerDatabase.P1LW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW2") {
			CurrentShootingPlayer = PlayerDatabase.P1LW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW3") {
			CurrentShootingPlayer = PlayerDatabase.P1LW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW4") {
			CurrentShootingPlayer = PlayerDatabase.P1LW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW1") {
			CurrentShootingPlayer = PlayerDatabase.P1RW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW2") {
			CurrentShootingPlayer = PlayerDatabase.P1RW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW3") {
			CurrentShootingPlayer = PlayerDatabase.P1RW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW4") {
			CurrentShootingPlayer = PlayerDatabase.P1RW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD1") {
			CurrentShootingPlayer = PlayerDatabase.P1LD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD2") {
			CurrentShootingPlayer = PlayerDatabase.P1LD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD3") {
			CurrentShootingPlayer = PlayerDatabase.P1LD3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD1") {
			CurrentShootingPlayer = PlayerDatabase.P1RD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD2") {
			CurrentShootingPlayer = PlayerDatabase.P1RD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD3") {
			CurrentShootingPlayer = PlayerDatabase.P1RD3;
		}

		// P2
		else if (PlayerDatabase.GameplayPossession == "P2C1") {
			CurrentShootingPlayer = PlayerDatabase.P2C1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C2") {
			CurrentShootingPlayer = PlayerDatabase.P2C2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C3") {
			CurrentShootingPlayer = PlayerDatabase.P2C3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C4") {
			CurrentShootingPlayer = PlayerDatabase.P2C4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW1") {
			CurrentShootingPlayer = PlayerDatabase.P2LW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW2") {
			CurrentShootingPlayer = PlayerDatabase.P2LW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW3") {
			CurrentShootingPlayer = PlayerDatabase.P2LW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW4") {
			CurrentShootingPlayer = PlayerDatabase.P2LW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW1") {
			CurrentShootingPlayer = PlayerDatabase.P2RW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW2") {
			CurrentShootingPlayer = PlayerDatabase.P2RW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW3") {
			CurrentShootingPlayer = PlayerDatabase.P2RW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW4") {
			CurrentShootingPlayer = PlayerDatabase.P2RW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD1") {
			CurrentShootingPlayer = PlayerDatabase.P2LD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD2") {
			CurrentShootingPlayer = PlayerDatabase.P2LD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD3") {
			CurrentShootingPlayer = PlayerDatabase.P2LD3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD1") {
			CurrentShootingPlayer = PlayerDatabase.P2RD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD2") {
			CurrentShootingPlayer = PlayerDatabase.P2RD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD3") {
			CurrentShootingPlayer = PlayerDatabase.P2RD3;
		}

		// Update Action Text
		if (GameplayRebBreakShot.GenericShot == "Goalie Rating") {
			ActionText.text = "By rolling a " + GameplayRebBreakShot.DiceRoll + ", " + CurrentShootingPlayer + " has a chance for a goalie rating.";
		}

		else if (GameplayRebBreakShot.GenericShot == "Goal Chance") {
			ActionText.text = "By rolling a " + GameplayRebBreakShot.DiceRoll + ", " + CurrentShootingPlayer + " has a chance for a goal.";
		}

		else if (GameplayRebBreakShot.GenericShot == "Lose") {
			ActionText.text = "By rolling a " + GameplayRebBreakShot.DiceRoll + ", " + CurrentShootingPlayer + " has lost the puck without a shot.";
		}

		else if (GameplayRebBreakShot.GenericShot == "Rebound") {
			ActionText.text = "By rolling a " + GameplayRebBreakShot.DiceRoll + ", " + CurrentShootingPlayer + " caused a rebound opportunity.";
		}

		else if (GameplayRebBreakShot.GenericShot == "Shot") {
			ActionText.text = "By rolling a " + GameplayRebBreakShot.DiceRoll + ", " + CurrentShootingPlayer + " shoots the puck, which is saved.";
		}
	}
