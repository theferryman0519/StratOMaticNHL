...
public class EnableObjects15 : MonoBehaviour {
...
// --------------- STATIC VARIABLES ---------------
	...
	public static string PuckOwnerFrom;
	public static string PuckOwnerTo;
	public static string PuckOwnerToInitial;
	public static string PuckOwnerFromPlayer;
	public static string PuckOwnerToPlayer;
	public static string AfterLosingPuckString;
...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
		// Update From Player
		if (PuckOwnerFrom == "P1C1") {
			PuckOwnerFromPlayer = PlayerDatabase.P1C1;
		}

		else if (PuckOwnerFrom == "P1C2") {
			PuckOwnerFromPlayer = PlayerDatabase.P1C2;
		}

		else if (PuckOwnerFrom == "P1C3") {
			PuckOwnerFromPlayer = PlayerDatabase.P1C3;
		}

		else if (PuckOwnerFrom == "P1C4") {
			PuckOwnerFromPlayer = PlayerDatabase.P1C4;
		}

		else if (PuckOwnerFrom == "P1LW1") {
			PuckOwnerFromPlayer = PlayerDatabase.P1LW1;
		}

		else if (PuckOwnerFrom == "P1LW2") {
			PuckOwnerFromPlayer = PlayerDatabase.P1LW2;
		}

		else if (PuckOwnerFrom == "P1LW3") {
			PuckOwnerFromPlayer = PlayerDatabase.P1LW3;
		}

		else if (PuckOwnerFrom == "P1LW4") {
			PuckOwnerFromPlayer = PlayerDatabase.P1LW4;
		}

		else if (PuckOwnerFrom == "P1RW1") {
			PuckOwnerFromPlayer = PlayerDatabase.P1RW1;
		}

		else if (PuckOwnerFrom == "P1RW2") {
			PuckOwnerFromPlayer = PlayerDatabase.P1RW2;
		}

		else if (PuckOwnerFrom == "P1RW3") {
			PuckOwnerFromPlayer = PlayerDatabase.P1RW3;
		}

		else if (PuckOwnerFrom == "P1RW4") {
			PuckOwnerFromPlayer = PlayerDatabase.P1RW4;
		}

		else if (PuckOwnerFrom == "P1LD1") {
			PuckOwnerFromPlayer = PlayerDatabase.P1LD1;
		}

		else if (PuckOwnerFrom == "P1LD2") {
			PuckOwnerFromPlayer = PlayerDatabase.P1LD2;
		}

		else if (PuckOwnerFrom == "P1LD3") {
			PuckOwnerFromPlayer = PlayerDatabase.P1LD3;
		}

		else if (PuckOwnerFrom == "P1RD1") {
			PuckOwnerFromPlayer = PlayerDatabase.P1RD1;
		}

		else if (PuckOwnerFrom == "P1RD2") {
			PuckOwnerFromPlayer = PlayerDatabase.P1RD2;
		}

		else if (PuckOwnerFrom == "P1RD3") {
			PuckOwnerFromPlayer = PlayerDatabase.P1RD3;
		}

		else if (PuckOwnerFrom == "P2C1") {
			PuckOwnerFromPlayer = PlayerDatabase.P2C1;
		}

		else if (PuckOwnerFrom == "P2C2") {
			PuckOwnerFromPlayer = PlayerDatabase.P2C2;
		}

		else if (PuckOwnerFrom == "P2C3") {
			PuckOwnerFromPlayer = PlayerDatabase.P2C3;
		}

		else if (PuckOwnerFrom == "P2C4") {
			PuckOwnerFromPlayer = PlayerDatabase.P2C4;
		}

		else if (PuckOwnerFrom == "P2LW1") {
			PuckOwnerFromPlayer = PlayerDatabase.P2LW1;
		}

		else if (PuckOwnerFrom == "P2LW2") {
			PuckOwnerFromPlayer = PlayerDatabase.P2LW2;
		}

		else if (PuckOwnerFrom == "P2LW3") {
			PuckOwnerFromPlayer = PlayerDatabase.P2LW3;
		}

		else if (PuckOwnerFrom == "P2LW4") {
			PuckOwnerFromPlayer = PlayerDatabase.P2LW4;
		}

		else if (PuckOwnerFrom == "P2RW1") {
			PuckOwnerFromPlayer = PlayerDatabase.P2RW1;
		}

		else if (PuckOwnerFrom == "P2RW2") {
			PuckOwnerFromPlayer = PlayerDatabase.P2RW2;
		}

		else if (PuckOwnerFrom == "P2RW3") {
			PuckOwnerFromPlayer = PlayerDatabase.P2RW3;
		}

		else if (PuckOwnerFrom == "P2RW4") {
			PuckOwnerFromPlayer = PlayerDatabase.P2RW4;
		}

		else if (PuckOwnerFrom == "P2LD1") {
			PuckOwnerFromPlayer = PlayerDatabase.P2LD1;
		}

		else if (PuckOwnerFrom == "P2LD2") {
			PuckOwnerFromPlayer = PlayerDatabase.P2LD2;
		}

		else if (PuckOwnerFrom == "P2LD3") {
			PuckOwnerFromPlayer = PlayerDatabase.P2LD3;
		}

		else if (PuckOwnerFrom == "P2RD1") {
			PuckOwnerFromPlayer = PlayerDatabase.P2RD1;
		}

		else if (PuckOwnerFrom == "P2RD2") {
			PuckOwnerFromPlayer = PlayerDatabase.P2RD2;
		}

		else if (PuckOwnerFrom == "P2RD3") {
			PuckOwnerFromPlayer = PlayerDatabase.P2RD3;
		}

		// Update To Player
		if (PuckOwnerTo == "P1C1") {
			PuckOwnerToPlayer = PlayerDatabase.P1C1;
		}

		else if (PuckOwnerTo == "P1C2") {
			PuckOwnerToPlayer = PlayerDatabase.P1C2;
		}

		else if (PuckOwnerTo == "P1C3") {
			PuckOwnerToPlayer = PlayerDatabase.P1C3;
		}

		else if (PuckOwnerTo == "P1C4") {
			PuckOwnerToPlayer = PlayerDatabase.P1C4;
		}

		else if (PuckOwnerTo == "P1LW1") {
			PuckOwnerToPlayer = PlayerDatabase.P1LW1;
		}

		else if (PuckOwnerTo == "P1LW2") {
			PuckOwnerToPlayer = PlayerDatabase.P1LW2;
		}

		else if (PuckOwnerTo == "P1LW3") {
			PuckOwnerToPlayer = PlayerDatabase.P1LW3;
		}

		else if (PuckOwnerTo == "P1LW4") {
			PuckOwnerToPlayer = PlayerDatabase.P1LW4;
		}

		else if (PuckOwnerTo == "P1RW1") {
			PuckOwnerToPlayer = PlayerDatabase.P1RW1;
		}

		else if (PuckOwnerTo == "P1RW2") {
			PuckOwnerToPlayer = PlayerDatabase.P1RW2;
		}

		else if (PuckOwnerTo == "P1RW3") {
			PuckOwnerToPlayer = PlayerDatabase.P1RW3;
		}

		else if (PuckOwnerTo == "P1RW4") {
			PuckOwnerToPlayer = PlayerDatabase.P1RW4;
		}

		else if (PuckOwnerTo == "P1LD1") {
			PuckOwnerToPlayer = PlayerDatabase.P1LD1;
		}

		else if (PuckOwnerTo == "P1LD2") {
			PuckOwnerToPlayer = PlayerDatabase.P1LD2;
		}

		else if (PuckOwnerTo == "P1LD3") {
			PuckOwnerToPlayer = PlayerDatabase.P1LD3;
		}

		else if (PuckOwnerTo == "P1RD1") {
			PuckOwnerToPlayer = PlayerDatabase.P1RD1;
		}

		else if (PuckOwnerTo == "P1RD2") {
			PuckOwnerToPlayer = PlayerDatabase.P1RD2;
		}

		else if (PuckOwnerTo == "P1RD3") {
			PuckOwnerToPlayer = PlayerDatabase.P1RD3;
		}

		else if (PuckOwnerTo == "P2C1") {
			PuckOwnerToPlayer = PlayerDatabase.P2C1;
		}

		else if (PuckOwnerTo == "P2C2") {
			PuckOwnerToPlayer = PlayerDatabase.P2C2;
		}

		else if (PuckOwnerTo == "P2C3") {
			PuckOwnerToPlayer = PlayerDatabase.P2C3;
		}

		else if (PuckOwnerTo == "P2C4") {
			PuckOwnerToPlayer = PlayerDatabase.P2C4;
		}

		else if (PuckOwnerTo == "P2LW1") {
			PuckOwnerToPlayer = PlayerDatabase.P2LW1;
		}

		else if (PuckOwnerTo == "P2LW2") {
			PuckOwnerToPlayer = PlayerDatabase.P2LW2;
		}

		else if (PuckOwnerTo == "P2LW3") {
			PuckOwnerToPlayer = PlayerDatabase.P2LW3;
		}

		else if (PuckOwnerTo == "P2LW4") {
			PuckOwnerToPlayer = PlayerDatabase.P2LW4;
		}

		else if (PuckOwnerTo == "P2RW1") {
			PuckOwnerToPlayer = PlayerDatabase.P2RW1;
		}

		else if (PuckOwnerTo == "P2RW2") {
			PuckOwnerToPlayer = PlayerDatabase.P2RW2;
		}

		else if (PuckOwnerTo == "P2RW3") {
			PuckOwnerToPlayer = PlayerDatabase.P2RW3;
		}

		else if (PuckOwnerTo == "P2RW4") {
			PuckOwnerToPlayer = PlayerDatabase.P2RW4;
		}

		else if (PuckOwnerTo == "P2LD1") {
			PuckOwnerToPlayer = PlayerDatabase.P2LD1;
		}

		else if (PuckOwnerTo == "P2LD2") {
			PuckOwnerToPlayer = PlayerDatabase.P2LD2;
		}

		else if (PuckOwnerTo == "P2LD3") {
			PuckOwnerToPlayer = PlayerDatabase.P2LD3;
		}

		else if (PuckOwnerTo == "P2RD1") {
			PuckOwnerToPlayer = PlayerDatabase.P2RD1;
		}

		else if (PuckOwnerTo == "P2RD2") {
			PuckOwnerToPlayer = PlayerDatabase.P2RD2;
		}

		else if (PuckOwnerTo == "P2RD3") {
			PuckOwnerToPlayer = PlayerDatabase.P2RD3;
		}

		// Update Action Text
		if (GameplayPickAction.DeterminedAction.Contains("Inside")) {
			ActionText.text = PuckOwnerFromPlayer + " loses the puck to " + PuckOwnerToPlayer + ", who now has an inside shot.";
		}

		else if (GameplayPickAction.DeterminedAction.Contains("Outside")) {
			ActionText.text = PuckOwnerFromPlayer + " loses the puck to " + PuckOwnerToPlayer + ", who now has an outside shot.";
		}

		else if (GameplayPickAction.DeterminedAction.Contains("Breakaway")) {
			ActionText.text = PuckOwnerFromPlayer + " loses the puck to " + PuckOwnerToPlayer + ", who now has an breakaway shot.";
		}

		else {
			ActionText.text = PuckOwnerFromPlayer + " loses the puck to " + PuckOwnerToPlayer + ", who now has possession of the puck.";
		}
	}
	...
	public void GetNewPuckController() {
		// Randomize Any Player
		RandomizeAnyPlayer = Random.Range(1,6);

		// Set From Player
		PuckOwnerFrom = PlayerDatabase.GameplayPossession;

		// Set Initial To Player
		if (GameplayPickAction.DeterminedAction == "Lose Puck - Inside Any") {
			if (RandomizeAnyPlayer == 1) {
				PuckOwnerToInitial = "C";
			}

			else if (RandomizeAnyPlayer == 2) {
				PuckOwnerToInitial = "LW";
			}

			else if (RandomizeAnyPlayer == 3) {
				PuckOwnerToInitial = "RW";
			}

			else if (RandomizeAnyPlayer == 4) {
				PuckOwnerToInitial = "LD";
			}

			else if (RandomizeAnyPlayer == 5) {
				PuckOwnerToInitial = "RD";
			}

			AfterLosingPuckString = GameplayPickAction.DeterminedAction;
			GameplayPickAction.DeterminedAction = "None";
		}

		else if (GameplayPickAction.DeterminedAction == "Lose Puck - Outside Only C") {
			PuckOwnerToInitial = "C";
			AfterLosingPuckString = GameplayPickAction.DeterminedAction;
			GameplayPickAction.DeterminedAction = "None";
		}
		
		else if (GameplayPickAction.DeterminedAction == "Lose Puck - Outside Only LW") {
			PuckOwnerToInitial = "LW";
			AfterLosingPuckString = GameplayPickAction.DeterminedAction;
			GameplayPickAction.DeterminedAction = "None";
		}
		
		else if (GameplayPickAction.DeterminedAction == "Lose Puck - Outside Only RW") {
			PuckOwnerToInitial = "RW";
			AfterLosingPuckString = GameplayPickAction.DeterminedAction;
			GameplayPickAction.DeterminedAction = "None";
		}
		
		else if (GameplayPickAction.DeterminedAction == "Lose Puck - Outside Only LD") {
			PuckOwnerToInitial = "LD";
			AfterLosingPuckString = GameplayPickAction.DeterminedAction;
			GameplayPickAction.DeterminedAction = "None";
		}
		
		else if (GameplayPickAction.DeterminedAction == "Lose Puck - Outside Only RD") {
			PuckOwnerToInitial = "RD";
			AfterLosingPuckString = GameplayPickAction.DeterminedAction;
			GameplayPickAction.DeterminedAction = "None";
		}
		
		else if (GameplayPickAction.DeterminedAction == "Lose Puck - Outside Only Any") {
			if (RandomizeAnyPlayer == 1) {
				PuckOwnerToInitial = "C";
			}
		...
		else if (GameplayPickAction.DeterminedAction == "Lose Puck - Any") {
			if (RandomizeAnyPlayer == 1) {
				PuckOwnerToInitial = "C";
			}
		...
		else if (GameplayPickAction.DeterminedAction == "Lose Puck Any - Breakaway") {
			if (RandomizeAnyPlayer == 1) {
				PuckOwnerToInitial = "C";
			}
		...
		else if (GameplayPassing.PassingString == "Lose Puck to Any") {
			if (RandomizeAnyPlayer == 1) {
				PuckOwnerToInitial = "C";
			}
			...
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose Puck to C") {
			PuckOwnerToInitial = "C";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose Puck to LD") {
			PuckOwnerToInitial = "LD";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose Puck to LW") {
			PuckOwnerToInitial = "LW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose Puck to RD") {
			PuckOwnerToInitial = "RD";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose Puck to RW") {
			PuckOwnerToInitial = "RW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot Any: I-Any") {
			if (RandomizeAnyPlayer == 1) {
				PuckOwnerToInitial = "C";
			}
		...
		else if (GameplayPassing.PassingString == "Lose, Inside Shot C: I-C") {
			PuckOwnerToInitial = "C";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot C: I-LD") {
			PuckOwnerToInitial = "C";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot C: I-LW") {
			PuckOwnerToInitial = "C";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot C: I-RD") {
			PuckOwnerToInitial = "C";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot C: I-RW") {
			PuckOwnerToInitial = "C";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot LW: I-C") {
			PuckOwnerToInitial = "LW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot LW: I-LD") {
			PuckOwnerToInitial = "LW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot LW: I-LW") {
			PuckOwnerToInitial = "LW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot LW: I-RD") {
			PuckOwnerToInitial = "LW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot LW: I-RW") {
			PuckOwnerToInitial = "LW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot RW: I-C") {
			PuckOwnerToInitial = "RW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot RW: I-LD") {
			PuckOwnerToInitial = "RW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot RW: I-LW") {
			PuckOwnerToInitial = "RW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot RW: I-RD") {
			PuckOwnerToInitial = "RW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Inside Shot RW: I-RW") {
			PuckOwnerToInitial = "RW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Outside Shot Any") {
			if (RandomizeAnyPlayer == 1) {
				PuckOwnerToInitial = "C";
			}
		...
		else if (GameplayPassing.PassingString == "Lose, Outside Shot C") {
			PuckOwnerToInitial = "C";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Outside Shot LD") {
			PuckOwnerToInitial = "LD";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Outside Shot LW") {
			PuckOwnerToInitial = "LW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Outside Shot RD") {
			PuckOwnerToInitial = "RD";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}
		
		else if (GameplayPassing.PassingString == "Lose, Outside Shot RW") {
			PuckOwnerToInitial = "RW";
			AfterLosingPuckString = GameplayPassing.PassingString;
			GameplayPassing.PassingString = "None";
		}

		else if (Buttons20.LosePuckString == "Lose Puck to Any") {
			if (RandomizeAnyPlayer == 1) {
				PuckOwnerToInitial = "C";
			}
			...
			AfterLosingPuckString = Buttons20.LosePuckString;
			Buttons20.LosePuckString = "None";
		}

		// Set To Player
		if (PlayerDatabase.GameplayLine == "F1D1") {
			if (PuckOwnerFrom.Contains("P1")) {
				if (PuckOwnerToInitial == "C") {
					PuckOwnerTo = "P2C1";
				}

				else if (PuckOwnerToInitial == "LW") {
					PuckOwnerTo = "P2LW1";
				}

				else if (PuckOwnerToInitial == "RW") {
					PuckOwnerTo = "P2RW1";
				}

				else if (PuckOwnerToInitial == "LD") {
					PuckOwnerTo = "P2LD1";
				}

				else if (PuckOwnerToInitial == "RD") {
					PuckOwnerTo = "P2RD1";
				}
			}

			else if (PuckOwnerFrom.Contains("P2")) {
				if (PuckOwnerToInitial == "C") {
					PuckOwnerTo = "P1C1";
				}
		...
		PlayerDatabase.GameplayPossession = PuckOwnerTo;
	}
