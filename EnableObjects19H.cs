...
public class EnableObjects19H : MonoBehaviour {
...
// --------------- UPDATE FUNCTION ---------------
	void Update() {
		UpdatingScoreboard();
		ActionText.text = "The powerplay is now over, and " + PlayerDatabase.GameplayPenaltyPlayer + " is out of the box. The players are getting set for a faceoff.";
	}
