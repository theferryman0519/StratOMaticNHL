...
// --------------- PUBLIC VARIABLES ---------------
	...
	public Image IntimidationButton;
...
// --------------- STATIC VARIABLES ---------------
	...
	public static string IntimidationPos;
	public static string IntimidatingPlayer;
...
// --------------- ENABLING OBEJCTS FUNCTIONS ---------------
	public void EnableMainObjects() {
		...
		IntimidationButton.enabled = true;
	}
...
// --------------- DISABLING OBEJCTS FUNCTIONS ---------------
	public void DisableMainObjects() {
		...
		IntimidationButton.enabled = false;
	}
...
// --------------- UPDATING TEXT FUNCTIONS ---------------
	...
	public void UpdatingActionText() {
		...
		if (PlayerDatabase.GameplayPossession == "P1C1") {
			CurrentPlayer = PlayerDatabase.P1C1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C2") {
			CurrentPlayer = PlayerDatabase.P1C2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C3") {
			CurrentPlayer = PlayerDatabase.P1C3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1C4") {
			CurrentPlayer = PlayerDatabase.P1C4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW1") {
			CurrentPlayer = PlayerDatabase.P1LW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW2") {
			CurrentPlayer = PlayerDatabase.P1LW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW3") {
			CurrentPlayer = PlayerDatabase.P1LW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LW4") {
			CurrentPlayer = PlayerDatabase.P1LW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW1") {
			CurrentPlayer = PlayerDatabase.P1RW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW2") {
			CurrentPlayer = PlayerDatabase.P1RW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW3") {
			CurrentPlayer = PlayerDatabase.P1RW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RW4") {
			CurrentPlayer = PlayerDatabase.P1RW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD1") {
			CurrentPlayer = PlayerDatabase.P1LD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD2") {
			CurrentPlayer = PlayerDatabase.P1LD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1LD3") {
			CurrentPlayer = PlayerDatabase.P1LD3;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD1") {
			CurrentPlayer = PlayerDatabase.P1RD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD2") {
			CurrentPlayer = PlayerDatabase.P1RD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P1RD3") {
			CurrentPlayer = PlayerDatabase.P1RD3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C1") {
			CurrentPlayer = PlayerDatabase.P2C1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C2") {
			CurrentPlayer = PlayerDatabase.P2C2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C3") {
			CurrentPlayer = PlayerDatabase.P2C3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2C4") {
			CurrentPlayer = PlayerDatabase.P2C4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW1") {
			CurrentPlayer = PlayerDatabase.P2LW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW2") {
			CurrentPlayer = PlayerDatabase.P2LW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW3") {
			CurrentPlayer = PlayerDatabase.P2LW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LW4") {
			CurrentPlayer = PlayerDatabase.P2LW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW1") {
			CurrentPlayer = PlayerDatabase.P2RW1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW2") {
			CurrentPlayer = PlayerDatabase.P2RW2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW3") {
			CurrentPlayer = PlayerDatabase.P2RW3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RW4") {
			CurrentPlayer = PlayerDatabase.P2RW4;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD1") {
			CurrentPlayer = PlayerDatabase.P2LD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD2") {
			CurrentPlayer = PlayerDatabase.P2LD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2LD3") {
			CurrentPlayer = PlayerDatabase.P2LD3;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD1") {
			CurrentPlayer = PlayerDatabase.P2RD1;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD2") {
			CurrentPlayer = PlayerDatabase.P2RD2;
		}

		else if (PlayerDatabase.GameplayPossession == "P2RD3") {
			CurrentPlayer = PlayerDatabase.P2RD3;
		}

		// Get Intimidating Player
		if (IntimidationPos == "P1C1") {
			IntimidatingPlayer = PlayerDatabase.P1C1;
		}

		else if (IntimidationPos == "P1C2") {
			IntimidatingPlayer = PlayerDatabase.P1C2;
		}

		else if (IntimidationPos == "P1C3") {
			IntimidatingPlayer = PlayerDatabase.P1C3;
		}

		else if (IntimidationPos == "P1C4") {
			IntimidatingPlayer = PlayerDatabase.P1C4;
		}

		else if (IntimidationPos == "P1LW1") {
			IntimidatingPlayer = PlayerDatabase.P1LW1;
		}

		else if (IntimidationPos == "P1LW2") {
			IntimidatingPlayer = PlayerDatabase.P1LW2;
		}

		else if (IntimidationPos == "P1LW3") {
			IntimidatingPlayer = PlayerDatabase.P1LW3;
		}

		else if (IntimidationPos == "P1LW4") {
			IntimidatingPlayer = PlayerDatabase.P1LW4;
		}

		else if (IntimidationPos == "P1RW1") {
			IntimidatingPlayer = PlayerDatabase.P1RW1;
		}

		else if (IntimidationPos == "P1RW2") {
			IntimidatingPlayer = PlayerDatabase.P1RW2;
		}

		else if (IntimidationPos == "P1RW3") {
			IntimidatingPlayer = PlayerDatabase.P1RW3;
		}

		else if (IntimidationPos == "P1RW4") {
			IntimidatingPlayer = PlayerDatabase.P1RW4;
		}

		else if (IntimidationPos == "P1LD1") {
			IntimidatingPlayer = PlayerDatabase.P1LD1;
		}

		else if (IntimidationPos == "P1LD2") {
			IntimidatingPlayer = PlayerDatabase.P1LD2;
		}

		else if (IntimidationPos == "P1LD3") {
			IntimidatingPlayer = PlayerDatabase.P1LD3;
		}

		else if (IntimidationPos == "P1RD1") {
			IntimidatingPlayer = PlayerDatabase.P1RD1;
		}

		else if (IntimidationPos == "P1RD2") {
			IntimidatingPlayer = PlayerDatabase.P1RD2;
		}

		else if (IntimidationPos == "P1RD3") {
			IntimidatingPlayer = PlayerDatabase.P1RD3;
		}

		else if (IntimidationPos == "P2C1") {
			IntimidatingPlayer = PlayerDatabase.P2C1;
		}

		else if (IntimidationPos == "P2C2") {
			IntimidatingPlayer = PlayerDatabase.P2C2;
		}

		else if (IntimidationPos == "P2C3") {
			IntimidatingPlayer = PlayerDatabase.P2C3;
		}

		else if (IntimidationPos == "P2C4") {
			IntimidatingPlayer = PlayerDatabase.P2C4;
		}

		else if (IntimidationPos == "P2LW1") {
			IntimidatingPlayer = PlayerDatabase.P2LW1;
		}

		else if (IntimidationPos == "P2LW2") {
			IntimidatingPlayer = PlayerDatabase.P2LW2;
		}

		else if (IntimidationPos == "P2LW3") {
			IntimidatingPlayer = PlayerDatabase.P2LW3;
		}

		else if (IntimidationPos == "P2LW4") {
			IntimidatingPlayer = PlayerDatabase.P2LW4;
		}

		else if (IntimidationPos == "P2RW1") {
			IntimidatingPlayer = PlayerDatabase.P2RW1;
		}

		else if (IntimidationPos == "P2RW2") {
			IntimidatingPlayer = PlayerDatabase.P2RW2;
		}

		else if (IntimidationPos == "P2RW3") {
			IntimidatingPlayer = PlayerDatabase.P2RW3;
		}

		else if (IntimidationPos == "P2RW4") {
			IntimidatingPlayer = PlayerDatabase.P2RW4;
		}

		else if (IntimidationPos == "P2LD1") {
			IntimidatingPlayer = PlayerDatabase.P2LD1;
		}

		else if (IntimidationPos == "P2LD2") {
			IntimidatingPlayer = PlayerDatabase.P2LD2;
		}

		else if (IntimidationPos == "P2LD3") {
			IntimidatingPlayer = PlayerDatabase.P2LD3;
		}

		else if (IntimidationPos == "P2RD1") {
			IntimidatingPlayer = PlayerDatabase.P2RD1;
		}

		else if (IntimidationPos == "P2RD2") {
			IntimidatingPlayer = PlayerDatabase.P2RD2;
		}

		else if (IntimidationPos == "P2RD3") {
			IntimidatingPlayer = PlayerDatabase.P2RD3;
		}

		// Updating Action Text
		ActionText.text = IntimidatingPlayer + " is attempting to intimidate against " + CurrentPlayer + " before their attempt at an inside shot.";
	}
